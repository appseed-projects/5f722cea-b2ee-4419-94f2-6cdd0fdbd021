...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-01 09:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5f722cea-b2ee-4419-94f2-6cdd0fdbd021.git
$ cd 5f722cea-b2ee-4419-94f2-6cdd0fdbd021
```
